...
public class IncomeConsumptionBatchConfig {
    ...
    public Step incomeConsumptionStep(JobRepository jobRepository,
                        ...
                        ItemReader<NcmCnsmp> incomeConsumptionItemReader,
    ...
    @Bean
    public FlatFileItemReader<NcmCnsmp> incomeConsumptionItemReader() {
    ...
    @Bean
    public ItemProcessor<NcmCnsmp, IncomeConsumption> incomeConsumptionProcessor(AdministrativeDistrictRepository administrativeDistrictRepository) {
        return ncmCnsmp -> {
            ...
            AdministrativeDistrict dong = administrativeDistrictRepository
                    .findByAdministrativeCode(ncmCnsmp.getAdstrdCode())
                    .orElse(null);

            // convertToStore 메서드를 호출하여 Stor 객체를 Store 엔티티로 변환
            return ncmCnsmp.convertToIncomeConsumption(dong, ncmCnsmp);
        };
    }
}
